...
- [`walkthrough.md`](walkthrough.md) — наглядный разбор стенда (что делает k6, связь с Grafana,
  где результаты) + галерея скриншотов.
...
Снимать на пике (стадия 10 VU прогона k6) — там виден потолок CPU подов Ollama.
